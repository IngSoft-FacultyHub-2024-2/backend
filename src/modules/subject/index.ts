import { addSubject, getSubjects, getSubjectById, updateSubject, teacherIsCoordinator } from './services/subjectService';
...
export { getEvents, addEvent, addSubject, getSubjectById, updateSubject, teacherIsCoordinator,
